      ...
      tabPanel(
        ...
        flowLayout(
          ...
          wellPanel(
            ...
            fluidRow(
              p("filterNHP is a dynamic application and taxonomy changes frequently. Therefore, we encourage you (the app user) to review the search filters generated by filterNHP and adapt them to your own needs. For further details, please refer to our publication: Cassidy et al.,", em("in review", .noWS = "after"), ". To report a bug or request a new feature, please use the ",
                a("GitHub repository",
